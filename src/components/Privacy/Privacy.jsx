    ...
    return (
        ...
        <Navbar/>
            <div className='privay-policy'>
                ...
                <h3 className="color">Interpretation</h3>
                ...
                <h3 className="color">Definitions</h3>
                <p>For the purposes of this privacy Policy.</p>
                <div className="definitions">
                    <p><b>Account</b>means a unique account created for You
                        to access our Service or parts of our Service.</p>
                    <p><b>Compnay</b>(referred to as either "the Company",
                        "We", "Us" or "Our" in this Agreement) refers to
                        Payshiga Technologies Inc , 8th The Green, Ste A.
                        Kent, DE 19901.</p>
                    <p><b>Cookies</b>are small files that are placed on Your
                    ...
                    <p><b>Device</b>means any device that can access the Service
                        such as a computer, a cellphone or a digital tablet.</p>
                    <p><b>Personal Data</b>is any information that relates to an
                        identified or identifiable individual.</p>
                    <p><b>Service</b>refers to the Website.</p>
                    <p><b>Service Provider</b>Provider means any natural or legal
                    ...
                    <p><b>Usage Data</b>refers to data collected automatically,
                        either generated by the use of the Service or from the
                        Service infrastructure itself (for example, the duration
                        of a page visit).</p>
                    <p><b>Website</b>refers to Payshiga, accessible from www.payshiga.com</p>
                    <p><b>You</b>You means the individual accessing or using the Service, or
                        the company, or other legal entity on behalf of which
                        such individual is accessing or using the Service, as
                        applicable.</p>
                </div>
                <h2>Collecting and Using Your Personal Data</h2>
                <h3 className='color'>Types of Data Collected</h3>
                <h4 className='color'>Personal Data</h4>
                ...
                <h4 className='color'>Usage Data</h4>
                ...
                <h4 className='color'>Tracking Technologies and Cookies</h4>
                ...
                <li><b>Cookies or Browser Cookies.</b>A cookie is a small file placed on Your Device. You can instruct
                ...
                <li><b>Web Beacons.</b>Certain sections of our Service and our emails may contain small electronic files
                ...
                <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or
                    mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn
                ...
                <div className="definitions">
                    ...
                    <p>Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to
                        use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies,
                        the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
                    ...
                    <p>Type: Persistent Cookies</p>
                    <p>Administered by: Us</p>
                    <p>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details
                        or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to
                        re-enter your preferences every time You use the Website.</p>
                </div>
                <p>For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy</p>
                <h3 className='color'>Use of Your Personal Data</h3>
                <p>The Company may use Personal Data for the following purposes:</p>
                <div className="definitions">
                    <p><b>To Provide and maintain our Service,</b>including the monitor the usgae of our Service.</p>
                    <p><b>To manage Your Account: </b>to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities
                        of the Service that are available to You as a registered user.</p>
                    <p><b>For the performance of a contract: </b>the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased
                        or of any other contract with Us through the Service.</p>
                    <p><b>To contact You: </b>: To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push
                    ...
                    <p><b>To provide You </b>with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have
                    ...
                    <p><b>For business transfers: </b>We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or
                    ...
                    <p><b>For other purposes:</b>We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional
                        campaigns and to evaluate and improve our Service, products, services, marketing and your experience.</p>
                </div>
                ...
                <h3 className='color'>Retention of Your Personal Data</h3>
                ...
                <h3 className='color'>Transfer of Your Personal Data</h3>
                ...
                <h3 className='color'>Delete Your Personal Data</h3>
                ...
                <h3 className='color'>Discloure of Your Personal Data</h3>
                <h4 className='color'>Business Transactions</h4>
                <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                <h4 className='color'>Law enforcement</h4>
                <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                <h4 className='color'>Other legal requirements</h4>
                ...
                <h3 className='color'>Security of Your Personal Data</h3>
                ...
                <li>By email:support@payshiga.com</li>
            </div>
            <Footer/>
        </>
    )
